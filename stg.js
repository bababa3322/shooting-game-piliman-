...
function setEnemy() {
    ...
    if( 4<= sec && sec<10){
        if(tmr%20 == 0) setObject(1,5,1300,60+rnd(600),-16,0,1*stage);//敵1
    }
    if( 14<= sec&& sec<20){
        if(tmr%20 == 0) setObject(1,6,1300,60+rnd(600),-12,8,3*stage);//敵2
    }
    if( 24<= sec&& sec<30){
        if(tmr%20 == 0) setObject(1,7,1300,360+rnd(300),-48,-10,5*stage);//敵3
    }
    if( 34<= sec&& sec<50){
    ...
    if( 54<= sec&& sec<70){
        if(tmr%20 == 0) {
            setObject(1,5,1300,60+rnd(300),-16,4,1*stage);//敵1
            setObject(1,5,1300,360+rnd(300),-16,-4,1*stage);//敵1
        }
    }
    if( 74<= sec&& sec<90){
        if(tmr%20 == 0)setObject(1,6,1300,60+rnd(600),-12,8,3*stage);//敵2
    ...
    if( 94<= sec&& sec<110){
        if(tmr%10 == 0)setObject(1,5,1300,360,-24,rnd(11)-5,1*stage);//敵1
        if(tmr%20 == 0)setObject(1,7,1300,rnd(300),-56,4+rnd(12),5*stage);//敵3
    }
}
